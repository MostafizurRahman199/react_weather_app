    ...
    <div className='p-4 flex flex-col md:grid grid-cols-2 my-8 rounded-xl shadow-lg md:w-[800px]'>
        <List sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper' }}>
          <ListItem alignItems="flex-start">
            <ListItemAvatar>
              <Avatar alt="City Icon" src={`https://cdn-icons-png.flaticon.com/512/4781/4781517.png`} />
            </ListItemAvatar>
            <ListItemText
          ...
          <ListItem>
            <ListItemAvatar>
              <Avatar alt="Temperature Icon" src="https://img.icons8.com/color/48/temperature.png" />
            </ListItemAvatar>
            <ListItemText primary={`Temperature: ${searchResults.temperature}°C`} />
          </ListItem>
          <Divider component="li" />
          <ListItem>
            <ListItemAvatar>
              <Avatar alt="Feels Like Icon" src="https://static-00.iconduck.com/assets.00/face-with-thermometer-emoji-256x242-wwm3cwyc.png" />
            </ListItemAvatar>
          ...
          <ListItem>
            <ListItemAvatar>
              <Avatar alt="Humidity Icon" src="https://img.icons8.com/color/48/humidity.png" />
            </ListItemAvatar>
          ...
          <ListItem>
            <ListItemAvatar>
              <Avatar alt="Pressure Icon" src="https://img.icons8.com/color/48/pressure.png" />
            </ListItemAvatar>
          ...
          <ListItem>
            <ListItemAvatar>
              <Avatar alt="Wind Speed Icon" src="https://img.icons8.com/color/48/wind.png" />
            </ListItemAvatar>
            <ListItemText primary={`Wind Speed: ${searchResults.windSpeed} m/s`} />
          </ListItem>
        </List>
      <Card sx={{ display: 'flex' }}>
        

        {/* Dynamically set the CardMedia image based on the temperature */}
            <CardMedia
    component="img"
