...
export default function ResultBox({ searchResults }) {
  ...
  const getTemperatureImage = (temperature) => {
    if (temperature > 30) {
      ...
      return "https://img.freepik.com/premium-photo/warm-yellow-sunlight-through-three-foliage-beautiful-sunshine-streaming-through-tree-leaves-bright-yellow-sun-light-green-plants-warm-sunny-weather-summer-awakening-nature_77829-7093.jpg"; // Replace with actual image URL for warm weather
